...
public class DataBindingThirdSampleActivity extends AppCompatActivity {
    private Button updateNamesDataBindingThirdSampleButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateNamesDataBindingThirdSampleButton = (Button)findViewById(R.id.updateNamesDataBindingThirdSampleButton);
