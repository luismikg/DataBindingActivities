...
public class DataBindingSecondSampleActivity extends AppCompatActivity {
    private Button updateNamesDataBindingSecondSampleButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateNamesDataBindingSecondSampleButton = (Button)findViewById(R.id.updateNamesDataBindingSecondSampleButton);
